...
A: It helps webpages be accessible

2. Name two big differences between ```display: block;``` and ```display: inline;```.

A: Display inline puts your items in the same line and block puts them on a new line
...
A: You are able to create directories quicker, branch out and work on repo's at the same time as well
